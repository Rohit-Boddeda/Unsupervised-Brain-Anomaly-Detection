...
from Latent_SB.dataset import dataset
from i2sb import NewRunner
...
def create_training_options():
    ...
    parser.add_argument("--masterport",      type=str,  default="6024",        help="master port")
...
def main(opt):
    ...
    train_dataset = dataset.IXIDataset(opt, root_dir="./Preprocessed_Data/IXI_jpg/",
                                                anomaly_source_path="./dtd/images/",
                                                resize_shape=[128, 128])
    val_dataset = dataset.IXIDataset(opt, root_dir="./Preprocessed_Data/IXI_jpg/",
                                              anomaly_source_path="./dtd/images/",
                                              resize_shape=[128, 128])
    
    # note: images should be normalized to [-1,1] for corruption methods to work properly

    run = NewRunner(opt, log)
